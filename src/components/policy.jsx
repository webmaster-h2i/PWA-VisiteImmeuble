export default function Home() {
    return(
        <div className="text-white m-5">
            ...
            <div><h2 className="mb-2 mt-2 text-lg underline">Collecte des renseignements personnels</h2></div>
            ...
            <div><h2 className="mb-2 mt-2 text-lg underline">Formulaires&nbsp;et interactivité:</h2><div>Vos renseignements personnels sont collectés par le biais de formulaire, à savoir :</div>
            <div className="mb-2 mt-2">
                <ul>
            ...
            <div>Nous utilisons les renseignements ainsi collectés pour les finalités suivantes :</div>
            <div><h2 className="mb-2 mt-2 text-lg underline">Droit d’opposition et de retrait</h2></div>
            ...
            <div>Code postal :&nbsp; 69006</div>
            <div>Courriel :&nbsp; serviceinternet@h2i.fr</div>
            <div>Téléphone :&nbsp; 04 72 68 25 00</div>
            <div>Section du site web :&nbsp;&nbsp; https://www.h2i.fr/</div>
            <div>
                <h2 className="mb-2 mt-2 text-lg underline">Droit d’accès</h2>
            </div>
            ...
            <div>Téléphone :&nbsp; 04 72 68 25 00</div>
            <div>Section du site web :&nbsp;&nbsp; https://www.h2i.fr/</div>
            <div><h2 className="mb-2 mt-2 text-lg underline">Sécurité</h2></div>
            ...
            <div><h2 className="mb-2 mt-2 text-lg underline">Législation</h2></div>
            <div>Nous nous engageons à respecter les dispositions législatives énoncées dans :</div>
            <div className="mb-2 mt-2">Législation:  RGPD</div>
            </div>
        </div>
    )
}
